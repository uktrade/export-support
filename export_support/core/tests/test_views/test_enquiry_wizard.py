    ...
    mock_zendesk_form_action_class().save.assert_called_with(
        {
            ...
            "_custom_fields": [
                ...
                {
                    "333": ['andorra__ess_export', 'albania__ess_export', 'austria__ess_export',
                            'bosnia_and_herzegovina__ess_export', 'belgium__ess_export',
                            'bulgaria__ess_export', 'switzerland__ess_export', 'cyprus__ess_export',
                            'czechia__ess_export', 'germany__ess_export', 'denmark__ess_export',
                            'estonia__ess_export', 'spain__ess_export', 'finland__ess_export',
                            'france__ess_export', 'greece__ess_export', 'croatia__ess_export',
                            'hungary__ess_export', 'ireland__ess_export', 'israel__ess_export',
                            'iceland__ess_export', 'italy__ess_export', 'liechtenstein__ess_export',
                            'lithuania__ess_export', 'luxembourg__ess_export', 'latvia__ess_export',
                            'monaco__ess_export', 'montenegro__ess_export',
                            'north_macedonia__ess_export', 'malta__ess_export',
                            'netherland__ess_export', 'norway__ess_export', 'poland__ess_export',
                            'portugal__ess_export', 'romania__ess_export', 'serbia__ess_export',
                            'sweden__ess_export', 'slovenia__ess_export', 'slovakia__ess_export',
                            'san_marino__ess_export', 'turkey__ess_export',
                            'vatican_city__ess_export', 'kosovo__ess_export']
                },
                {"666": "SW1A 2BL"},
